...
//                   <span className="ms-2 fw-bold">{user?.username || "User"}</span>
//                 </div>
...
export default function SideHeader() {
  ...
  return (
    <div className={styles.overlay} onClick={closeSideHeader}>
        ...
        <div className="p-4">
          ...
          <div className="d-flex flex-column gap-3 mb-4">
            <Link 
              ...
              onClick={closeSideHeader}
            >
              <CiHeart className="fs-4 text-dark" />
              <span className="ms-2">Wishlist</span>
              {wishlistItems?.length > 0 && (
                <span className="badge bg-dark ms-2">{wishlistItems.length}</span>
              )}
            </Link>
            ...
            >
              ...
              {totalItems > 0 && (
                <span className="badge bg-dark ms-2">{totalItems}</span>
              )}
            </Link>
            ...
            {isAuthenticated ? (
              ...
              <div className="d-flex flex-column gap-2">
                ...
                <Link 
                  ...
                  onClick={closeSideHeader}
                >
                  <span className="ms-5">Register</span>
                </Link>
              </div>
            )}
          </div>
